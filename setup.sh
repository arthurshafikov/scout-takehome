...
echo ""
echo "3. Seed the database with initial photos (REQUIRED for first-time setup):"
echo -e "   ${YELLOW}cd backend && make seed${NC}"
echo -e "   (This uploads 50 sample images from dataset/images/ to MinIO)"
echo ""
...
echo -e "   ${YELLOW}curl -H 'X-API-Key: scout-api-key-12345' http://localhost:8080/photos${NC}"
echo ""
